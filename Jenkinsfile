        ...
        stage('deploy to tomcat server'){
            steps{
                sshagent(['ubuntu']){
                    ...
                    ssh -o StrictHostkeyChecking=no ubuntu@3.95.199.9 /opt/tomcat-9/bin/stoptomat.sh
                    ssh -o StrictHostKeyChecking=no ubuntu@3.95.199.9 /opt/tomcat-9/bin/startomcat.sh
                    """
                }
            }
        }
